...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('ajaxcomments', MODX_CORE_PATH . 'components/ajaxcomments/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/ajaxcomments/model/schema/ajaxcomments.mysql.schema.xml';
