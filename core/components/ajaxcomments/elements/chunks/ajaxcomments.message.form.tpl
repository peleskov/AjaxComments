    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-6">
            <div class="form-group d-flex flex-column-reverse">
                ...
                <input class="d-none" type="number" name="rating" id="ac_Rating_{$branch_key}" value="1"  required/>
                <label class="label" for="ac_Rating_{$branch_key}">Оценка:</label>
            </div>
        </div>
    </div>
    <div class="form-group d-flex flex-column-reverse">
